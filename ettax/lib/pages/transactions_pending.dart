...
import 'package:ettax/components/transactions_container.dart';
import 'package:ettax/pages/transactions_done.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class TransactionPending extends StatefulWidget {
  // ignore: use_key_in_widget_constructors
  const TransactionPending({Key? key});
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  ...
                  .where('status',
                      isEqualTo: 'undone') // Filter only 'undone' transactions
                  .snapshots(),
